...
Deploy the [Sentinel Components](https://github.com/swiftsolves-msft/Azure-TPot/tree/main/sample/tpot_all/deployment) and for now [manually configure the T-Pot as follows](https://github.com/swiftsolves-msft/Azure-TPot/blob/main/sample/tpot_all/readme.md#azure-vm-t-pot-configuration)
